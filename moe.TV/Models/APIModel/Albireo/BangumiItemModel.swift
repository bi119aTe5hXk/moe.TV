...
struct AlbireoV1ImageModel: Codable, Hashable {
	var url: String?
	var width: Int?
...
protocol AlbireoV1CoverImageProviding {
	var image: String? { get set }
	var cover_image: AlbireoV1ImageModel? { get set }
}

extension AlbireoV1CoverImageProviding {
	var resolvedCoverImageURL: String? {
	...
	mutating func applyCoverImageFallback() {
		image = resolvedCoverImageURL
	}
}
...
struct BangumiItemModel: Codable, Hashable, Identifiable, AlbireoV1CoverImageProviding {
    let id:String
	...
	var cover_image: AlbireoV1ImageModel? = nil
    var type:Int
